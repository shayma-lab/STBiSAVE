  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/rapport': (context) => const RapportsPage(),
        '/objectif': (context) => const ObjectifPage(),
        '/compte': (context) => const ProfilePage(),
        '/home': (context) => const AcceuilPage(),
      },
    );
  }
}
                ...
                child: Column(
                  children: [
                    _buildFeatureCard(
                      ...
                      description: "Suivez et gérez toutes vos transactions bancaires.",
                      color: Color(0xFF0087d4),
                    ),
                    _buildFeatureCard(
                      icon: Icons.category_outlined,
                      title: "Catégoriser les transactions",
                      description: "Organisez vos dépenses par catégories (alimentation, loisirs, etc.).",
                      color: Color(0xFF0087d4),
                    ),
                    _buildFeatureCard(
                      icon: Icons.savings_outlined,
                      title: "Objectifs d'épargne",
                      description: "Fixez des objectifs d'épargne et suivez vos progrès.",
                      color: Color(0xFF0087d4),
                    ),
                    _buildFeatureCard(
